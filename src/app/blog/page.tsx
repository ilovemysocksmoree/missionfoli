...
const BlogPage = ({ }) => {
  ...
  const documentation: Documentation[] = [
    {
      ...
      status: "COMPLETED",
      icon: "document",
      link: "https://drive.google.com/file/d/14Vfr9Y03_EdtdHZLiZ9pzlXOas_Sf-MH/view?usp=sharing",
      date: "2025-04-30",
      pages: "544",
  ...
  const blogPosts: BlogPost[] = [
    ...
    {
      id: "002", 
      title: "The Dark Side of the “Vibe: Why AI‑Generated Code Is a Security Time Bomb”",
      description: "Comprehensive guide to Active Directory vulnerabilities and defensive strategies",
      category: "RESEARCH",
      status: "FEATURED",
      icon: "terminal",
      link: "https://medium.com/p/74862a8e544a",
      date: "2024-01-10",
      readTime: "12 min",
    },
    // {
